...
VOID MouseUpdate(VOID)
{
	...
	//ホイールの回転量を取得
	mouse.WheelValue = GetMouseHWheelRotVol();
...
/// <summary>
/// ボタンを押し続けたか、マウスコードで判断する
/// </summary>
/// <param name="MOUSE_INPUT_">MOUSE_INPUT_</param>
/// <param name="milliTime">押し続けていたらTRUE</param>
/// <returns></returns>
...
{
	if (mouse.OldButton[MOUSE_INPUT_] >= 1		//直前は押していて
		&& mouse.Button[MOUSE_INPUT_] == 0)		//今は押してないとき
	{
		return TRUE;		//マウスをクリックした
	}
	else
	{
